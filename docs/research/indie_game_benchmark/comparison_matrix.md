...
> **历史比较快照。** 本矩阵的“当前差距”和 P0/P1/P2 判断已被 [`docs/roadmap.md`](../../roadmap.md) 取代。涉及产品化关卡、每日/今日挑战、交互式教学或回放倍速的判断已被 [`.gf/project_contract.json`](../../../.gf/project_contract.json) 排除，只用于说明当时的外部证据，不得作为活跃建议。
