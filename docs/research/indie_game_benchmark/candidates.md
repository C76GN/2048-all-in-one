...
| 追加轮次 B：小网格战术与紧凑肉鸽 | 14 | 稳定参照系、路径预演、单屏课程、短局构筑、低端与隐私边界 |
| **合计** | **113** | 超过 60 项初筛门槛，并保留可追溯的增量轮次 |

来源分布：首轮 87 项含原作者源码托管 14 项（GitHub 13、GitLab 1）、作者/工作室官网或官方开发日志 31 项、作者 itch.io 21 项、官方商店页 21 项；追加轮次 A 的 12 项与轮次 B 的 14 项均由作者、开发者或发行商可控制页面复核。完整增量检索、替换与证据限制见 [R2-A 搜寻台账](./round_02_search.md)和 [R3-B 搜寻台账](./round_03_search.md)。
...
## F. 追加轮次 B：小网格战术与紧凑肉鸽（100–113）

本组在轮次启动时与首轮 87 项、20 份深度报告和追加轮次 A 名单逐项去重。GUNCHO、Card Crawl Adventure 与 Card Thief 属同一创作者谱系，且既有目录已有 ENYO 与 Maze Machina；保留它们是为了追踪同一设计语言从推撞、路径到 3D 方向资源的演化，不把五部作品误算成五种独立来源。Ending、MicRogue、FROGUE 因一手入口或版本身份不稳被明确淘汰，详见本轮台账。

| # | 候选（类别 / 平台） | 一手来源 | 代码/许可证 | 初筛理由 | 建议深挖维度 | 证据日期 / 状态 |
| ---: | --- | --- | --- | --- | --- | --- |
| 100 | GUNCHO（六角格射击战术肉鸽 / PC、移动端） | [作者周年开发日志](https://www.arnoldrauers.com/first-year-of-guncho/) | 当前源未见公开代码；商业素材不可复用 | 左轮弹巢与世界方向一一对应，把弹药 UI 变成空间规则；复盘还记录相机参照系的删改 | 方向不变量、敌人顺序、Puzzle/Daily、短局 build、鼠标/手柄/触控 | 2026-07-22 / 已核-B |
| 101 | Card Crawl Adventure（3×3 路径卡牌肉鸽 / PC、移动端） | [开发者/发行者 Steam 页](https://store.steampowered.com/app/2190260/Card_Crawl_Adventure/) | 当前源未见公开代码；商业素材不可复用 | 在九宫格上草拟路径，把攻击、法术、拾取与退路压成一次可预演选择 | 路径草稿、投影增量、原子提交、角色差异、周赛资格、多语言 | 2026-07-22 / 已核-B |
| 102 | Card Thief（3×3 潜行卡牌 / 移动端） | [开发者 Google Play 页](https://play.google.com/store/apps/details?id=com.tinytouchtales.cardthief) | 当前源未见公开代码；商业素材不可复用 | 用光源、潜行值、守卫和路线在单屏建立递增风险，极少文字仍能预告路径后果 | 威胁覆盖、路径预演、亮暗冗余、因果回顾、移动端误触恢复 | 2026-07-22 / 已核-B |
| 103 | Dungeons of Dreadrock（单屏网格战术解谜 / 多平台） | [开发者官网](https://dungeons-of-dreadrock.com/) | 当前源未见公开代码；商业素材不可复用 | 100 个手工小关以少量敌人、开关、门和陷阱逐层重组，复杂度进入课程而非常驻 HUD | 关卡目录、掌握进度、短会话、意图可读性、触控/手柄、隐私边界 | 2026-07-22 / 已核-B |
| 104 | Tinyfolks（极简队伍管理 RPG / PC、Web、移动端） | [作者 itch.io](https://pierre-vandermaesen.itch.io/tinyfolks)、[Google Play 开发者页](https://play.google.com/store/apps/details?hl=en&id=com.VandermaesenGames.Tinyfolks) | 当前源未见公开代码；商业素材不可复用 | 近单色稳定版式承载职业、城镇、装备和多生物群系；移动端页同时给出不收集/共享数据声明 | 短局 build、固定信息区、小字号、闪烁控制、Web/低端实测、隐私摘要 | 2026-07-22 / 已核-B |
| 105 | Labyrinth of Legendary Loot（装备驱动网格肉鸽 / PC、Android） | [作者 itch.io](https://dominaxis-games.itch.io/labyrinth-of-legendary-loot) | 当前源未见明确代码许可；按不可复用处理 | 基础属性少、必定命中、敌人可预测，复杂度集中在装备能力组合 | 装备解释、可预测敌人、重绑控制、短局长度、49 MB 包体与真实性能 | 2026-07-22 / 已核-B |
| 106 | Auro: A Monster-Bumping Adventure（六角推撞战术 / PC、移动端） | [开发者/发行者 Steam 页](https://store.steampowered.com/app/459680/Auro_A_MonsterBumping_Adventure/) | 当前源未见公开代码；商业素材不可复用 | 推撞、地形边缘和少量技能取代传统伤害交换，让每步改变空间压力 | 六角邻接、推撞预览、危险区、技能组合、移动端/桌面输入 | 2026-07-22 / 已核-B |
| 107 | Rust Bucket（单屏网格肉鸽 / Web、移动端） | [Nitrome 官方开发日志](https://www.nitrome.com/blog/articles/1363) | 当前源未见公开代码；商业素材不可复用 | 手工教学关与程序化 endless 共用敌人语法，官方日志保留原型演进与续关证据 | 手工/程序内容共用、敌人深度排序、续关、触控输入、长局恢复 | 2026-07-22 / 已核-B |
| 108 | Fidel Dungeon Rescue（可回退路径肉鸽解谜 / PC） | [开发者/发行者 Steam 页](https://store.steampowered.com/app/573170/Fidel_Dungeon_Rescue/) | 当前源未见公开代码；商业素材不可复用 | 把 REWIND 作为寻找最优路线的核心而非惩罚豁免，并强调 quick、无 grind 与无 filler | 路径优化、撤销成本、每日局、路线比较、失败复盘 | 2026-07-22 / 已核-B |
| 109 | FORWARD: Escape the Fold（单输入卡牌路径肉鸽 / PC、移动端） | [作者 itch.io](https://twotinydice.itch.io/forward-escape-the-fold) | 当前源未见公开代码；商业素材不可复用 | 单输入向前选择、约半小时一局、7 名角色与 100+ 物品体现“窄输入、深组合” | 单手主动作、信息展开、角色差异、物品组合、短局节奏 | 2026-07-22 / 已核-B |
| 110 | Militia（短局回合战术 / PC） | [开发者日志](https://blog.braingoodgames.com/category/militia/) | 当前源未见公开代码；商业素材不可复用 | 开发日志明确加入 threatened-unit 指示、矢量缩放文字与键盘/手柄支持 | 威胁提示、规则误读、缩放文本、控制器焦点、低规格表现 | 2026-07-22 / 已核-B |
| 111 | Gun Rounds（单按钮回合射击肉鸽 / PC、移动端） | [作者 itch.io](https://blabberf.itch.io/gunrounds) | 当前源未见公开代码；商业素材不可复用 | 官方标签明确互动教程与 one button，开发日志又提供性能问题和内存泄漏修复线索 | 单按钮输入、教学、命中反馈、性能/内存回归、移动端 | 2026-07-22 / 已核-B |
| 112 | Cardinal Quest 2（可接近的传统肉鸽 / PC、移动端、Web） | [开发者官网](https://cardinalquest2.com/) | 当前源未见公开代码；商业素材不可复用 | 官网明确追求 welcoming/approachable，职业、回合战术、云存档与榜单适合研究首局门槛 | 职业教学、命令简化、信息检索、云存档、排行榜资格 | 2026-07-22 / 已核-B |
| 113 | The Dungeon Beneath（队列站位自动战斗肉鸽 / PC） | [开发者官网](https://www.thedungeonbeneath.com/) | 当前源未见公开代码；商业素材不可复用 | 小队站位、攻击顺序和装备组合让网格位置成为回合前规划 | 站位预览、行动顺序、装备 build、结果解释、短局复盘 | 2026-07-22 / 已核-B |
