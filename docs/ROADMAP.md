...
总体原则：
1. 优先遵守项目文档：AI_MAINTENANCE.md、CODING_STYLE.md、docs/ROADMAP.md、docs/ARCHITECTURE.md、docs/VALIDATION.md、docs/VISUAL_STYLE.md、docs/SAVE_MODEL.md。
