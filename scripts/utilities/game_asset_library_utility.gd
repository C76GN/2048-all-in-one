## GameAssetLibraryUtility: 项目内通用素材库 Adapter。
##
## 复用 GFContentPackageUtility、GFResourceResolverUtility 和 GFContentPackageExportPlan，
## 负责注册 asset_library 内容包、解析稳定素材 ID，并生成项目素材审计报告。
...
const ASSET_LIBRARY_SOURCE_ROOT: String = "res://asset_library"
const ASSET_LIBRARY_MANIFEST_PATH: String = "res://asset_library/gf_content_package.json"
const ASSET_LIBRARY_IMPORT_SOURCES_PATH: String = "res://asset_library/import_sources.json"
const ASSET_LIBRARY_SOURCE_PACK_ROOT: String = "res://asset_library/source_packs"
const ASSET_LIBRARY_REVIEW_ROOT: String = "res://asset_library/review"
const ASSET_LIBRARY_REVIEW_RECORD_ROOT: String = "res://asset_library/review/records"
const ASSET_LIBRARY_SOURCE_PACK_RESOURCE_ROOT: String = "res://asset_library/review/source_packs"
const ASSET_LIBRARY_SLOT_MAP_PATH: String = "res://asset_library/review/asset_slot_map.tres"
const DEFAULT_AUDIT_JSON_PATH: String = "res://asset_library/reports/asset_audit.json"
const DEFAULT_AUDIT_MARKDOWN_PATH: String = "res://asset_library/reports/asset_audit.md"
const DEFAULT_REVIEW_CATALOG_JSON_PATH: String = "res://asset_library/reports/review_catalog_audit.json"
const DEFAULT_REVIEW_CATALOG_MARKDOWN_PATH: String = "res://asset_library/reports/review_catalog_audit.md"
...
func register_asset_library_content_package_resources() -> Dictionary:
	...
	var _source_registered: bool = _content_packages.register_source_root(ASSET_LIBRARY_SOURCE_ROOT)
	...
	if not _is_report_ok(catalog_report):
		_add_report_issue(
			...
			GFVariantData.get_option_string(catalog_report, "summary", "素材库内容包目录构建失败。")
		)
	...
	if not _is_report_ok(registration_report):
		_add_report_issue(
			...
			GFVariantData.get_option_string(registration_report, "summary", "素材库资源注册失败。")
		)
...
## 解析素材 ID 到 Godot 资源路径。
## @param asset_key: `asset.*` 稳定素材资源键。
