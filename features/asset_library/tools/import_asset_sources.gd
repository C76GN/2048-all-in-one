...
func _get_default_slot_definitions() -> Array[Dictionary]:
	return [
		...
		{
			"slot_id": "slot.audio.ui.cancel",
			"display_name": "UI Cancel",
			"expected_kind": "audio",
			"current_asset_key": "asset.audio.ui.printworks.cancel_soft_01",
			"current_library_path": "res://features/asset_library/resources/audio/ui/printworks_cancel_soft_01.ogg",
			"tags": PackedStringArray(["audio", "ui", "cancel"]),
			"notes": "Default menu cancellation sound.",
		},
		{
		...
		{
			"slot_id": "slot.audio.tile.move_blocked",
			"display_name": "Tile Move Blocked",
			"expected_kind": "audio",
			"current_asset_key": "asset.audio.tile.printworks.move_blocked_soft_01",
			"current_library_path": "res://features/asset_library/resources/audio/tile/printworks_move_blocked_soft_01.ogg",
			"tags": PackedStringArray(["audio", "tile", "move", "blocked"]),
			"notes": "Default invalid movement sound.",
		},
		{
		...
		{
			"slot_id": "slot.audio.tile.merge_chain",
			"display_name": "Tile Merge Chain",
			"expected_kind": "audio",
			"current_asset_key": "asset.audio.tile.printworks.merge_chain_soft_01",
			"current_library_path": "res://features/asset_library/resources/audio/tile/printworks_merge_chain_soft_01.ogg",
			"tags": PackedStringArray(["audio", "tile", "merge", "chain"]),
			"notes": "Default multi-merge chain sound.",
		},
		{
			"slot_id": "slot.audio.tile.transform",
			"display_name": "Tile Transform",
			"expected_kind": "audio",
			"current_asset_key": "asset.audio.tile.printworks.transform_soft_01",
			"current_library_path": "res://features/asset_library/resources/audio/tile/printworks_transform_soft_01.ogg",
			"tags": PackedStringArray(["audio", "tile", "merge", "transform"]),
			"notes": "Default transformed-merge sound.",
		},
		{
			"slot_id": "slot.audio.game.milestone",
			"display_name": "Game Milestone",
			"expected_kind": "audio",
			"current_asset_key": "asset.audio.game.printworks.milestone_soft_01",
			"current_library_path": "res://features/asset_library/resources/audio/game/printworks_milestone_soft_01.ogg",
			"tags": PackedStringArray(["audio", "game", "milestone"]),
			"notes": "Default target or milestone completion sound.",
		},
		{
