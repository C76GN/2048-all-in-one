...
const ASSET_LIBRARY_MANIFEST_PATH: String = "res://features/asset_library/resources/gf_content_package.json"
const ASSET_LIBRARY_IMPORT_SOURCES_PATH: String = "res://features/asset_library/resources/import_sources.json"
