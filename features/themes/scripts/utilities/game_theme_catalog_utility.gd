...
const CONTENT_PACKAGE_SOURCE_ROOT: String = "res://features/themes/resources"
const _REGISTRY_PATH: String = "res://features/themes/resources/registries/game_theme_registry.tres"
