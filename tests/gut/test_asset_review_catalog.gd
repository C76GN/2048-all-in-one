...
const IMPORT_SOURCES_PATH: String = "res://asset_library/import_sources.json"
const SLOT_MAP_PATH: String = "res://asset_library/review/asset_slot_map.tres"
const COORDINATE_GRID_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/world_space_coordinate_grid_1e36eed0.tres"
const COORDINATE_GRID_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/world_space_coordinate_grid.gdshader"
const MASK_TRANSITION_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/luminance_mask_texture_transition_aa1d8745.tres"
const MASK_TRANSITION_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/luminance_mask_texture_transition.gdshader"
const SHINE_SWEEP_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/shine_sweep_overlay_2683bab7.tres"
const SHINE_SWEEP_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/shine_sweep_overlay.gdshader"
const SHINE_SWEEP_ASSET_ID: String = "asset.review.manual.shader.notes.shine.sweep.overlay.2683bab7"
const SURFACE_MASKED_SHINE_SWEEP_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/surface_masked_shine_sweep_c6f76108.tres"
const SURFACE_MASKED_SHINE_SWEEP_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/surface_masked_shine_sweep.gdshader"
const SURFACE_MASKED_SHINE_SWEEP_ASSET_ID: String = "asset.review.manual.shader.notes.surface.masked.shine.sweep.c6f76108"
const SPACE_BACKGROUND_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/space_cloud_starfield_background_93f9a76f.tres"
const SPACE_BACKGROUND_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/space_cloud_starfield_background.gdshader"
const SPACE_BACKGROUND_ASSET_ID: String = "asset.review.manual.shader.notes.space.cloud.starfield.background.93f9a76f"
const FLICKER_NOISE_BACKGROUND_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/flicker_noise_background_7c2f83c3.tres"
const FLICKER_NOISE_BACKGROUND_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/flicker_noise_background.gdshader"
const FLICKER_NOISE_BACKGROUND_ASSET_ID: String = "asset.review.manual.shader.notes.flicker.noise.background.7c2f83c3"
const GYROID_FBM_BACKGROUND_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/gyroid_fbm_background_eeb8815a.tres"
const GYROID_FBM_BACKGROUND_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/gyroid_fbm_background.gdshader"
const GYROID_FBM_BACKGROUND_ASSET_ID: String = "asset.review.manual.shader.notes.gyroid.fbm.background.eeb8815a"
const RAIN_SNOW_WEATHER_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/rain_snow_weather_overlay_513017af.tres"
const RAIN_SNOW_WEATHER_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/rain_snow_weather_overlay.gdshader"
const RAIN_SNOW_WEATHER_ASSET_ID: String = "asset.review.manual.shader.notes.rain.snow.weather.overlay.513017af"
const STEAMPUNKDEMON_RAIN_SNOW_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/steampunkdemon_rain_snow_overlay_638a6683.tres"
const STEAMPUNKDEMON_RAIN_SNOW_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/steampunkdemon_rain_snow_overlay.gdshader"
...
const GLITCH_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/chromatic_aberration_glitch_c807ca4f.tres"
const GLITCH_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/chromatic_aberration_glitch.gdshader"
const GLITCH_ASSET_ID: String = "asset.review.manual.shader.notes.chromatic.aberration.glitch.c807ca4f"
const SCREEN_LENS_SHOCKWAVE_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/screen_lens_aberration_shockwave_5dfa21fd.tres"
const SCREEN_LENS_SHOCKWAVE_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/screen_lens_aberration_shockwave.gdshader"
const SCREEN_LENS_SHOCKWAVE_ASSET_ID: String = "asset.review.manual.shader.notes.screen.lens.aberration.shockwave.5dfa21fd"
const NEW_ITEM_RADIAL_SHINE_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/new_item_radial_shine_4ccdcf74.tres"
const NEW_ITEM_RADIAL_SHINE_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/new_item_radial_shine.gdshader"
const NEW_ITEM_RADIAL_SHINE_ASSET_ID: String = "asset.review.manual.shader.notes.new.item.radial.shine.4ccdcf74"
const HATCH_PATTERN_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/hand_drawn_hatch_tile_pattern_58c15683.tres"
const HATCH_PATTERN_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/hand_drawn_hatch_tile_pattern.gdshader"
const HATCH_PATTERN_ASSET_ID: String = "asset.review.manual.shader.notes.hand.drawn.hatch.tile.pattern.58c15683"
const ANIMATED_CHECKER_PATTERN_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/animated_checker_tile_pattern_4b84449f.tres"
const ANIMATED_CHECKER_PATTERN_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/animated_checker_tile_pattern.gdshader"
const ANIMATED_CHECKER_PATTERN_ASSET_ID: String = "asset.review.manual.shader.notes.animated.checker.tile.pattern.4b84449f"
const ANGLED_STRIPE_PATTERN_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/angled_stripe_tile_pattern_a1c96b85.tres"
const ANGLED_STRIPE_PATTERN_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/angled_stripe_tile_pattern.gdshader"
const ANGLED_STRIPE_PATTERN_ASSET_ID: String = "asset.review.manual.shader.notes.angled.stripe.tile.pattern.a1c96b85"
const SINE_WAVE_STRIPE_PATTERN_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/sine_wave_stripe_pattern_a7a2d8b2.tres"
const SINE_WAVE_STRIPE_PATTERN_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/sine_wave_stripe_pattern.gdshader"
const SINE_WAVE_STRIPE_PATTERN_ASSET_ID: String = "asset.review.manual.shader.notes.sine.wave.stripe.pattern.a7a2d8b2"
const NOISE_NODE_LINK_PATTERN_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/noise_node_link_tile_pattern_27ec9424.tres"
const NOISE_NODE_LINK_PATTERN_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/noise_node_link_tile_pattern.gdshader"
const NOISE_NODE_LINK_PATTERN_ASSET_ID: String = "asset.review.manual.shader.notes.noise.node.link.tile.pattern.27ec9424"
const SQUARE_WAVE_PATTERN_RECORD_PATH: String = "res://asset_library/review/records/manual_shader_notes/square_wave_tile_pattern_aef95b1d.tres"
const SQUARE_WAVE_PATTERN_SHADER_PATH: String = "res://asset_library/source_packs/manual_shader_notes/files/square_wave_tile_pattern.gdshader"
const SQUARE_WAVE_PATTERN_ASSET_ID: String = "asset.review.manual.shader.notes.square.wave.tile.pattern.aef95b1d"
const BURN_RECIPE_RECORD_PATH: String = "res://asset_library/review/records/manual_effect_notes/click_uv_radius_burn_card_recipe_293dea5f.tres"
const BURN_RECIPE_PATH: String = "res://asset_library/source_packs/manual_effect_notes/files/click_uv_radius_burn_card_recipe.md"
const BURN_RECIPE_ASSET_ID: String = "asset.review.manual.effect.notes.click.uv.radius.burn.card.recipe.293dea5f"
const BUTTON_WOBBLE_RECIPE_RECORD_PATH: String = "res://asset_library/review/records/manual_effect_notes/interactive_button_follow_wobble_recipe_8a5fa6f0.tres"
const BUTTON_WOBBLE_RECIPE_PATH: String = "res://asset_library/source_packs/manual_effect_notes/files/interactive_button_follow_wobble_recipe.md"
...
const POOLED_DROP_RECIPE_RECORD_PATH: String = "res://asset_library/review/records/manual_effect_notes/pooled_shader_drop_controller_recipe_54f8901e.tres"
const POOLED_DROP_RECIPE_PATH: String = "res://asset_library/source_packs/manual_effect_notes/files/pooled_shader_drop_controller_recipe.md"
